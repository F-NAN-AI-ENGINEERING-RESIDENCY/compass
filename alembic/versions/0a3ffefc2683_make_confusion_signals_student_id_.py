...
def upgrade() -> None:
    ...
    op.create_foreign_key(None, 'confusion_signals', 'students', ['student_id'], ['student_id'], ondelete='RESTRICT')
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint(None, 'confusion_signals', type_='foreignkey')
    op.create_foreign_key('confusion_signals_student_id_fkey', 'confusion_signals', 'students', ['student_id'], ['student_id'], ondelete='SET NULL')
    op.alter_column('confusion_signals', 'student_id',
               existing_type=sa.INTEGER(),
               nullable=True)
    # ### end Alembic commands ###
